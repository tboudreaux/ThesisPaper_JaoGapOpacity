...
mixing timescales in these low mass stars are so short \textbf{\citep[between $10^{7}$s
...
\textbf{The slight temperature differences between these models are
...
corrections \textbf{on} effective temperature at these low temperatures. The
