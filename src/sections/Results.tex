...
\begin{figure}
	\centering
	\includegraphics[width=0.44\textwidth]{src/figures/NotebookFigs/OPAL_Jao_locator.png}
	\includegraphics[width=0.44\textwidth]{src/figures/NotebookFigs/OPLIB_Jao_locator.png}
