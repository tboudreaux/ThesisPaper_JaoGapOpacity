...
\begin{figure}
	\centering
	\includegraphics[width=0.45\textwidth]{src/figures/NotebookFigs/JaoGapEDR3.png}
...
\begin{figure*}
	...
	black meaning radiative). The lines trace the models core temperature, core
...
dramatically lowers the temperature at which radiation will dominate energy transport
...
the effect of different opacity {\color{red} [estimates?]} on Gap properties}.
...
observed and modeled Gaps. Opacity provides one, as yet unexplored, knob to turn
