...
\input{src/sections/opacity.tex}

% \input{src/sections/SSCM.tex}

\input{src/sections/Modeling.tex}

\input{src/sections/Results.tex}
...
\input{src/appendicies/pytopsscrape.tex}

\input{src/appendicies/interp.tex}
...
\begin{acknowledgments}
	...
	their support and for useful disscusion related to the topic of this paper.
	Additionally, we would like to thank James Colgan and the Los Alamos T-1
	group for their assistance with the OPLIB opacity tables and support for
	the public release of \texttt{pyTOPSScrape}. We acknowledge the support of
	a NASA grant (No. 80NSSC18K0634). 
\end{acknowledgments}
