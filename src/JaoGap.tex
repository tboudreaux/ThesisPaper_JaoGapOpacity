...
\textbf{While kissing instability has been the most widley adopted model to
explain the existance of the Jao Gap, slightly different mechanisms have also
been proposed. \citet{MacDonald2018} make use of a fully implicit stellar
evolution suite which treats convective mixing as a diffusive property. Under
this treatment the instability results only in a single mixing event --- as
opposed to periodic mixings. Single mixing events may be more in line with
...
identify an second underdensity of stars below the canonical gap, does leave
